    ...
    <>
      <div className='col-span-2 px-3 pb-7'>
        ...
        {notes.length > 0
          ? (
            <div
              className={`relative ${isDark ? "bg-white/2 border-white/10 hover:bg-white/4" : "bg-white !text-[#2d3748] hover:bg-neutral-100"} backdrop-blur-md border text-white rounded-2xl shadow-xl p-[20px] mb-5 cursor-pointer h-[]`}
