...
const Tasks = () => {
  ...
  return (
    <>
      <div className="w-full col-span-1 row-span-1 grid grid-cols-1 grid-rows-[98px_1fr] overflow-y-auto">
        <div
        ...
        >
          ...
          <div className="w-full flex justify-between items-center pl-[64px] py-[16px]">
            <p>Title</p>
            
            <div className="flex justify-between items-center">
              <p className="pr-[8454px]">Status</p>

              <p className="pr-[104px]">Priority</p>
            </div>
          </div>
        </div>
