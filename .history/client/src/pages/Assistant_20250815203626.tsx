...
const Assistant = () => {
  ...
  return (
    <div className={`relative col-span-1 row-span-1 grid grid-cols-[1fr] grid-rows-[1fr] ${isDark ? "bg-white/2 border-white/6" : "bg-white"} backdrop-blur-md border rounded-md shadow-xl p-[24px] overflow-y-auto mt-4`}>
      ...
      <div
        className={`absolute bottom-[24px] right-0 left-0 m-auto grid grid-rows-[1fr_32px] gap-[12px] w-full max-w-[690px] border ${isDark ? "bg-white/6 border-white/10" : "bg-white/10 border-black/30"} backdrop-blur-md rounded-2xl shadow-lg px-4 py-3 pb-`}
      >
        <textarea
          ref={textareaRef}
          onInput={handleInput}
