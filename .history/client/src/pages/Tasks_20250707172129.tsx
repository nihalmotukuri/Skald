  ...
  return (
    <>
      <div className="w-full col-span-1 row-span-1 grid grid-cols-1 grid-rows-[68px_1fr] overflow-y-auto">
        <div className="row-span-1 col-span-1 py-[16px] flex justify-between items-center px-[2px]"
          style={{
        ...
        <div className="row-span-1 col-span-1 overflow-y-auto">
          <ul className="pt-[24px] px-[16px] flex flex-col gap-2">
            <li className="flex items-start justify-between bg-white/1 backdrop-blur-md border border-white/5 rounded-md shadow-lg py-3 px-4">
              <div className="flex items-start gap-4">
                ...
                />
                <div>
                  <p className="text-[16px] font-medium text-white pb-[6px]">{tasks[0].title}</p>
            ...
            <li className="flex items-start justify-between bg-white/1 backdrop-blur-md border border-white/5 rounded-md shadow-lg p-3">
              <div className="flex items-start gap-4">
                <Checkbox
                  ...
                  onCheckedChange={() => toggleTask(tasks[1].id)}
                />
                <div>
                  <p className="text-[16px] font-medium text-white pb-[6px]">{tasks[1].title}</p>
                  <p className="text-xs text-slate-400">
                    Due: {format(tasks[1].due, "PPPp")}
                  </p>
                </div>
              </div>
            </li>
