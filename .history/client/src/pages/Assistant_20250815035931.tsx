...
const Assistant = () => {
  ...
  return (
    <div className={`relative col-span-1 row-span-1 grid grid-cols-[1fr] grid-rows-[1fr] ${isDark ? "bg-white/2" : "bg-neutral-200"} backdrop-blur-md border border-white/6 rounded-md shadow-lg p-[24px] overflow-y-auto mt-4`}>
