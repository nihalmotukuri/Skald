...
const Tasks = () => {
  ...
  return (
    <>
      <div className="w-full col-span-1 row-span-1 grid grid-cols-1 grid-rows-[88px_1fr] overflow-y-auto">
        <div
        ...
        >
          ...
          <div className="w-full flex justify-between items-center py-[]">
            <p>Title</p>
