        ...
        {notes.length > 0
          ? (
            ...
            >
              ...
              alt="Note Image"
              />
              <p className={`absolute bottom-5 right-5 text-[14px] text-gray-300 px-[8px] py-1 rounded-2xl border ${isDark ? "border-white/20 bg-white/6" : "border- bg-white/6"} `}>✨ Latest note</p>
            </div>
          ) : null
        }
