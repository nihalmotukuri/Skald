  ...
  const renderDashboard = () => (
    <>
      <div className='col-span-2'>
        <div className='w-full h-[340px] grid grid-cols-[repeat(2,1fr)] gap-5 mb-5'>
          <div className='grid grid-cols-[repeat(2,1fr)] grid-rows-[repeat(9,1fr)] gap-3'>
            <div className={`col-1 row-span-5 ${isDark ? "bg-white/2 border-white/10" : "bg-neutral-200 !text-[#2d3748] border-black/30"} backdrop-blur-md border shadow-lg text-white rounded-xl p-[18px] flex flex-col justify-between`}>
            ...
            <div className={`col-1 row-span-4 ${isDark ? "bg-white/2 border-white/10" : "bg-neutral-200 !text-[#2d3748] border-black/30"} backdrop-blur-md border text-white rounded-xl p-[18px] flex flex-col justify-between shadow-lg`}>
            ...
            <div className={`col-2 row-start-1 row-end-5 ${isDark ? "bg-white/2 border-white/10" : "bg-neutral-200 !text-[#2d3748] border-black/30"} backdrop-blur-md border text-white rounded-xl p-[18px] flex flex-col justify-between shadow-lg`}>
            ...
            <div className={`col-2 row-start-5 row-end-10 ${isDark ? "bg-white/2 border-white/10" : "bg-neutral-200 !text-[#2d3748] border-black/30"} backdrop-blur-md border text-white rounded-xl p-[18px] flex flex-col justify-between shadow-lg`}>
      ...
      <div className='col-span-1'>
        ...
        <div className={`${notes.length > 0 ? "h-[693px]" : "h-[456px]"} mt-5 ${isDark ? "text-white border-white/10 bg-white/2" : "! text-[#2d3748] border-black/20 bg-neutral-200"} backdrop-blur-md border rounded-2xl shadow-lg py-[20px] px-[26px] grid grid-rows-[44px_1fr] shadow-lg`}>
            ...
            <ul className='h-full flex flex-col gap-2 overflow-y-auto relative'>
              {tasksThisWeek.length > 0
                ? tasksThisWeek.map(ct => (
                  <li className={`p-3 ${isDark ? "bg-white/6" : "bg-neutral-100"} rounded-lg shadow-md`} key={ct._id}>
