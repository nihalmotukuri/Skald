  ...
  const renderDashboard = () => (
    <>
      ...
      <div className='col-span-1'>
        ...
        <div className={`${notes.length > 0 ? "h-[693px]" : "h-[456px]"} mt-5 ${isDark ? "text-white border-white/10 bg-white/2" : "!text-black/60 border-black/20 bg-neutral-200"} backdrop-blur-md border rounded-2xl shadow-lg py-[20px] px-[26px] grid grid-rows-[44px_1fr]`}>
                ...
                ? tasksThisWeek.map(ct => (
                  <li className={`p-3 ${isDark ? "bg-white/6" : "bg-neutral-100"} rounded-lg`} key={ct._id}>
                    ...
                    <div className='flex justify-between'>
                      <span className={`text-[12px] py-[1px] px-[6px] rounded-sm text-gray-400 border ${isDark ? "border-white/20" : "border-black/30 bg-black/40 text-white"}`}>
                        {ct.taskList}
                      </span>
