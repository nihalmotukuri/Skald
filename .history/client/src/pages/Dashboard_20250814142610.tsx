  ...
  const renderDashboard = () => (
    <>
      ...
      <div className='col-span-1'>
        ...
        <div className={`${notes.length > 0 ? "h-[693px]" : "h-[456px]"} mt-5 ${isDark ? "text-gray-300 border-white/10 bg-white/2" : "text-black/60 border-black/20 bg-neutral-400/50"} backdrop-blur-md border rounded-2xl shadow-lg py-[20px] px-[26px] grid grid-rows-[44px_1fr]`}>
