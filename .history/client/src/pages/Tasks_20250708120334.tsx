    ...
    <>
      <div className="w-full col-span-1 row-span-1 grid grid-cols-1 grid-rows-[108px_1fr] overflow-y-auto relative">
        ...
        >
          ...
          <div className="w-full pr-[50px] pl-[64px] py-[16px] grid grid-cols-[1fr_160px_140px_20px] text-[14px]">
            <p>Title</p>
            <p>Status</p>
            <p>Priority</p>
          </div>
