    ...
    <>
      <div className='col-span-2'>
        ...
        {notes.length > 0
          ? (
            <div
              className={`relative ${ isDark ? "bg-white/2 border-white/10 hover:bg-white/4" : "bg-neutral-300 !text-[#2d3748] border-black/30 hover:bg-neutral" } backdrop-blur-md border text-white rounded-2xl shadow-lg p-[20px] mb-5 cursor-pointer`}
