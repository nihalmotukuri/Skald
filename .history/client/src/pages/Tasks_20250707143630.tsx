...
const Tasks = () => {
  return (
    <>
      <div className="h-full w-full col-span-1 row-span-1 grid-cols-1 grid-rows-[68px_1fr]">
        <div className="row-span-1 col-span-1 w-full py-[16px] flex justify-between items-center"
          style={{
