  ...
  const renderDashboard = () => (
    <>
      ...
      <div className='col-span-1'>
        ...
        <div className={`${notes.length > 0 ? "h-[683px]" : "h-[456px]"} mt-5 ${isDark ? "text-white border-white/10 bg-white/2" : "!text-[#2d3748] bg-white"} backdrop-blur-md border rounded-2xl shadow-xl py-[20px] px-[26px] grid grid-rows-[44px_1fr] shadow-lg`}>
