  ...
  return (
    <div className="w-full col-span-1 row-span-1 overflow-y pt-[16px]">
      <div className="w-full">
        {!writeNote && (
          <div
            className="w-[240px] bg-white/5 backdrop-blur-md border rounded-md shadow-lg text-[16px] py-[6px] h-[54px] w-[480px] border-1 border-white/50 outline-0 flex items-center px-[18px] text-white/50 flex justify-between"
          >
            <input
              className="outline-0"
