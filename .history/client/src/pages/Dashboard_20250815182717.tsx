          ...
          ? (
            ...
            >
              ...
              <img
                ...
                alt="Note Image"
              />
              <p className={`absolute bottom-5 right-5 text-[14px] px-[8px] py-1 rounded-2xl border ${isDark ? "text-gray-300 border-white/20 bg-white/6" : "text-white/60 border-black/20 bg-[#602bf8]"} `}>✨ Latest note</p>
            </div>
          ) : null
        }
