      ...
      <div className='col-span-2'>
        <div className='w-full h-[340px] grid grid-cols-[repeat(2,1fr)] gap-5 mb-5'>
          <div className='grid grid-cols-[repeat(2,1fr)] grid-rows-[repeat(9,1fr)] gap-3'>
            <div className={`col-1 row-span-5 ${isDark ? "bg-white/2 border-white/10" : "bg-white !text-[#2d3748] border-black/30"} backdrop-blur-md border shadow-lg text-white rounded-xl p-[18px] flex flex-col justify-between`}>
