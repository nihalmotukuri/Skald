  ...
  return (
    <div className="w-full col-span-1 row-span-1 overflow-y pt-[16px]">
      <div className="w-full">
        ...
        {writeNote && (
          <div
            className="min-h-[108px] w-[480px] bg-white/5 backdrop-blur-md border rounded-md shadow-lg text-[16px] p-[12px] border-1 border-white/50 outline-0 px-[18px] text-white/50"
          >
            <input
              className="text-2xl text outline-0" 
              type="text"
              placeholder="Title"
            />
          </div>
