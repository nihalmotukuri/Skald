        ...
        {notes.length > 0
          ? (
            ...
            >
              ...
              alt="Note Image"
              />
              <p className={`absolute bottom-5 right-5 text-[14px] px-[8px] py-1 rounded-2xl border ${isDark ? "text-gray-300 border-white/20 bg-white/6" : "text-gray-200 border-black/20 bg-neutral-400"} `}>✨ Latest note</p>
            </div>
          ) : null
        }
