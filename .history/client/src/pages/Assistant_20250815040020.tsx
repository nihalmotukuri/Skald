...
const Assistant = () => {
  ...
  return (
    <div className={`relative col-span-1 row-span-1 grid grid-cols-[1fr] grid-rows-[1fr] ${isDark ? "bg-white/2 border-white/6" : "bg-neutral-200 border-black/0"} backdrop-blur-md border rounded-md shadow-lg p-[24px] overflow-y-auto mt-4`}>
