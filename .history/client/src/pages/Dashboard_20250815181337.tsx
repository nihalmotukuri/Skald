          ...
          ? (
            ...
            >
              ...
              <img
                ...
                alt="Note Image"
              />
              <p className={`absolute bottom-5 right-5 text-[14px] px-[8px] py-1 rounded-2xl border ${isDark ? "text-gray-300 border-white/20 bg-white/6" : "text-black/60 border-none shadow-xs bg-[#f0f1f5]"} `}>✨ Latest note</p>
            </div>
          ) : null
        }
                ...
                ? tasksThisWeek.map(ct => (
                  <li className={`p-3 ${isDark ? "bg-white/6" : "bg-[#f0f1f5]"} rounded-lg shadow-md`} key={ct._id}>
                    ...
                    <div className='flex justify-between'>
                      <span className={`text-[12px] py-[1px] px-[6px] rounded-sm border ${isDark ? "border-white/20 text-gray-400" : "border-black/20 bg-[#373e4e] text-white/80"}`}>
                        {ct.taskList}
                      </span>
