    ...
    <>
      <div className="w-full col-span-1 row-span-1 grid grid-cols-1 grid-rows-[68px_1fr] overflow-y-auto">
        ...
        <div className="row-span-1 col-span-1 overflow-y-auto">
          <ul className="pt-[24px] px-[24px] flex flex-col gap-2">
            <li className="flex items-start justify-between bg-white/1 backdrop-blur-md border border-white/5 rounded-md shadow-lg py-2 px-3">
