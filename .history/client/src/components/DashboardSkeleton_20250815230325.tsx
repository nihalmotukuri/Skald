    ...
    return (
        <>
            ...
            <div className='col-span-1'>
                ...
                <Skeleton className='mt-5 bg-white/2 rounded-2xl py-[20px] px-[26px]'>
                    <Skeleton className='mb-[16px] h-[24px] w-[150px] rounded-xl bg-white/10' />

                    <ul className='flex flex-col gap-2'>
                        <Skeleton className={`h-[78px] w-full rounded-lg ${isDark ? "bg-white/2" : "bg-[#f5f5f5]"} p-3 py-4`}>
                            <Skeleton className={`${isDark ? "bg-white/10 h-[18px] w-[100px] rounded-md mb-4'`} />
