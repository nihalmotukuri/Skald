...
const features = [
  ...
  },
  {
    ...
    className: "col-span-3 lg:col-span-2",
    background: (
    <Integrations className="absolute right-2 top-4 h-[300px] border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105 bg-[#a3b4ff]" />
    ),
  },
  {
    Icon: CalendarIcon,
