...
const Sidebar = () => {
    ...
    const closeSidebar = () => (
        <div
            className="bg-[#1b1d26] m-[24px] rounded-[12px] flex flex-col justify-between"
        >
            <div className='flex flex-col items-center'>
                <div className="flex justify-center items-center mt-[10px]">
                    <img
                        src="/images/logo.png"
                        className="size-[28px] m-auto logo-animation mx-[12px] mt-[8px]" />
                </div>
            ...
            <div className="flex justify-center hover:bg-[#0f111a5f] p-[6px] m-[] rounded-[12px] cursor-pointer">
                <img
                    className="size-[28px] rounded-[10px]"
                    src="https://i.pinimg.com/736x/3b/73/48/3b73483fa5af06e3ba35f4f71e541e7a.jpg"
                    alt="profile-pic" />
            </div>
        </div>
