...
const Task = ({ task, toggleTask }: TaskProps) => {
    ...
    return (
        <li className={`${openTask ? "auto" : "h-[56px]"} flex flex-col items-start justify-between bg-white/2 backdrop-blur-md border border-white/6 rounded-md shadow-lg p-4 overflow-hidden`}>
            ...
            <div className="w-full mt-[12px] grid grid-cols-[1fr_300px]">
                <p className="text-slate-400 text-[14px] ml-[32px]">Podhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povaliPodhune levali, dhoddi ki povali</p>
            </div>
        </li>
    )
}
