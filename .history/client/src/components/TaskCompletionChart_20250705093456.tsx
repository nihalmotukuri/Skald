  ...
  const renderCenterLabel = () => {
    return (
      <foreignObject x="30" y="65" width="120" height="60">
        <div className="flex flex-col items-center justify-center w-full h-full text-white font-mono m-auto">
  ...
  return (
    ...
    >
      <Card className="bg-[#1b1d26] rounded-[18px] backdrop-blur-md border border-white/10 text-white shadow-lg">
        <CardHeader>
          <CardTitle className="text-white text-center text-[16px]">Task Completion</CardTitle>
        </CardHeader>
