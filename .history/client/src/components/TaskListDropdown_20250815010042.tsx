...
const TaskListDropdown = ({ selectedTaskList, setSelectedTaskList }: TaskListDropdownProps) => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        className={`${isDark ? "bg-white/5 border-white/10" : "bg-neutral-100 border-black/20 text-gray-600"} backdrop-blur-[8px] text-white border border-white/20 absolute z-10 right-[-136px] w-[160px]"
        align="start`}
      >
        <DropdownMenuGroup>
          <DropdownMenuItem
