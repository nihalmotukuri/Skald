  ...
  return (
    ...
    >
      <Card className="bg-[#1b1d26] rounded-[18px] backdrop-blur-md border border-white/10 text-white shadow-lg w-full">
        <CardHeader>
          <CardTitle className="text-white text-base font-medium">Pomodoro Timer</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center gap-4 pb-4">
          ...
          <div className="flex gap-2">
            {isRunning ? (
              ...
              <Button
                onClick={resume}
                className="bg-green-500 text-white hover:bg-green-600 transition cursor-pointer"
              >
                <VscDebugStart />
              </Button>
            )}
            <Button
              onClick={resetTimer}
              className="bg-slate-500 text-white hover:bg-slate-600 transition cursor-pointer"
              variant="secondary"
            >
              <CiRedo />
            </Button>
