    ...
    return (
        <>
            ...
            >
                {loading
                    ? (
                        <div className={`${isDark ? "bg-white/2" : "bg-[#eae5f7]"} backdrop-blur-sm absolute top-0 left-0 z-1 size-full flex justify-center items-center`}>
                            <LineWobble
                                size="80"
                                stroke="5"
                                bgOpacity="0.1"
                                speed="1.75"
                                color={isDark ? "#a3b4ff" : "#eae5f7"}
                            />
                        </div>
                    )
                    : user ? (
