            ...
            <div className={`w-full mt-[14px] mr-[300px] ${openTask ? "flex" : "hidden"} justify-between`}>
                ...
                <div className="flex items-end px-[14px]">
                    ...
                    <button
                        ...
                        className={`text-[14px] px-[16px] py-[2px] text-red-500  rounded-xl border ${isDark ? "border-red-900 hover:bg-red-100/10" : "border-red-600 hover:bg-red-100"} cursor-pointer`}
                    >Delete</button>
                </div>
            </div>
        </li>
