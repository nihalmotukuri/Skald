...
const DashboardGrid = () => {
    ...
    return (
        <>
            <main
                className={`${isDark ? "bg-[#0f111a]" : "bg-[f4f5f7] !text-[#2d3748]"} flex p-[24px] gap-[24px] h-screen relative`}
            >
                {loading
                    ? (
                            ...
                            <div className="flex-1 h-full w-full grid grid-cols-1 grid-rows-[60px_1fr] gap-0">
                                <div className="w-full row-span-1 col-span-1 flex justify-between items-center">
                                    <div className='h-[60px] flex items-center'>
                                        ...
                                        <p className={`text-[18px] pb-[4px] ${isDark ? "text-gray-400" : "text-blue-950/50"} flex items-center`}>
