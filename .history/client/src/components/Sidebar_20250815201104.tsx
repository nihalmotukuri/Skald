  ...
  const closeSidebar = () => (
    ...
    >
      ...
      >
        ...
        {showLogout
          ? (
            <div className={`absolute ${isDark ? "bg-white/20 backdrop-blur" : "bg-white/60 border border-black/40 backdrop-blur"} top-0 left-0 h-full w-full rounded-[10px] flex justify-center items-center text-2xl`}>
              <IoIosLogOut />
            </div>
          ) : null
        }
