    ...
    return (
        <li className="flex flex-col items-start justify-between bg-white/2 backdrop-blur-md border border-white/6 rounded-md shadow-lg p-4 overflow-hidden">
            <div className="w-full flex items-center gap-4">
                ...
                />
                <div className="w-full grid grid-cols-[1fr_160px_140px_30px_30px] items-center">
            ...
            <div className={`w-full mt-[14px] ${openTask ? "grid" : "hidden"} grid-cols-[1fr_300px] grid-rows-[1fr_1fr]`}>
                <p className="text-slate-400 text-[14px] ml-[32px]">{task.description}</p>

                <p className="text-xs text-slate-400 row-span-2 col-span-1">
