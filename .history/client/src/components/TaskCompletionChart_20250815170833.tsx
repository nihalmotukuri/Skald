...
const TaskCompletionChart = ({ total, completed }: TaskCompletionChartProps) => {
  ...
  return (
    <motion.div className="h-full w-full">
      <Card className={`${ isDark ? "bg-white/2 border-white/10 border" : "bg-white !text-[#2d3748] border-none" } backdrop-blur-md text-white rounded-2xl shadow-xl h-full w-full`}>
