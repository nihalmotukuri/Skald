...
const Heatmap = () => {
  ...
  return (
    <motion.div>
      <Card className={`${isDark ? "text-gray-300 border-white/10 bg-white/2" : "text-[#2d3748] border-black/20 bg-neutral-200"} backdrop-blur-md border rounded-2xl shadow-lg p-6 text-slate-400 w-full`}>
