...
import TaskCompletionChart from './""
...
const DashboardGrid = () => {
  return (
    <div className="flex-1 my-[24px] mr-[24px] flex flex-col">
        ...
        <div className="w-full mt-[18px] flex-1 grid grid-cols-3 grid-rows-3">
            <div className="row-span-1 col-span-1 bg-[#1b1d26] rounded-[18px]"></div>
        </div>
    </div>
  )
}
