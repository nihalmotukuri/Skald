...
return (
  <motion.div>
    <Card className={`${isDark ? "text-slate-400 border-white/10 bg-white/2" : "text-[#2d3748] bg-white"} backdrop-blur-md border rounded-2xl shadow-lg p-6 w-full shadow-lg`}>
