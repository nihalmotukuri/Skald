...
const SelectTaskList = ({ selectTaskList, currentTaskList }: SelectTaskListProps) => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className={`${isDark ? "bg-white/5 border-white/10 text-white" : "bg-neutral-100/10 !border-black/20 text-gray-600"} backdrop-blur-[8px] border border-white/20 absolute z-1000 right-[-56px]`}>
        <DropdownMenuGroup>
