...
const AddTaskList = () => {
    ...
    return (
        <DropdownMenu open={open} onOpenChange={setOpen}>
            ...
            <DropdownMenuContent className={`${isDark ? "bg-white/5 border-white/10 text-white" : "bg-neutral-100/10 !border-black/20 text-gray-600"} backdrop-blur-xl border rounded-md shadow-lg absolute z-[1] w-[240px] right-[-180px] text-white p-[12px]`} align="start">
