            ...
            <div className={`w-full mt-[14px] mr-[300px] ${openTask ? "flex" : "hidden"} justify-between`}>
                <div>
                    ...
                    <p className="flex items-center gap-1 text-[12px] text-white/50 ml-8 mt-2">
                        ...
                        <span className={`${task.status === "Cancelled" ? "line-through" : ""} pl-[4px] ${formatDueDate(task.date!, task.time!, task.completed!).includes('Overdue') ? "text-red-900" : (isDark ? "" : "text-black/60")}`}>
