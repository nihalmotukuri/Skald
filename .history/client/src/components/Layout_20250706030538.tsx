        ...
        <>
            <main className="bg-[#0f111a] flex">
                ...
                <div className="flex-1 my-[24px] mr-[24px] grid grid-cols-1 grid-rows-[60px 1fr]">
                    <div className="w-full row-span-1 col-span-3 flex justify-between items-center">
                    ...
                    <div className='row-span-1 col-span-3 h-full w-full'>
                        <div className="w-full grid grid-cols-3 gap-4 auto-rows-[330px]">
