...
const PomodoroTimer = ({ duration = 2 * 60 }) => {
  ...
  }, [minutes, seconds, isStarted, duration, totalSeconds]);
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg h-full w-full py-0">
