  ...
  const renderCenterLabel = () => {
    return (
      <foreignObject x="30" y="65" width="120" height="60">
        <div className="flex flex-col items-center justify-center w-full h-full text-white font-mono ml-[11px] mt-[8px]">
          <span className="text-[12px] text-center text-slate-400 w-full">TASKS COMPLETED</span>
  ...
  return (
    ...
    >
      <Card className="bg-[#1b1d26] rounded-[18px] backdrop-blur-md border border-white/10 text-white shadow-lg">
        <CardHeader>
          {/* <CardTitle className="text-white text-base font-medium">Task Completion</CardTitle> */}
        </CardHeader>
