...
const Sidebar = () => {
    ...
    return (
        ...
        >
            {/* <div> */}
                <div className="w-[206px] flex justify-center items-center mt-[10px]">
                    <img
                        src="/images/logo.png"
                ...
                <ul className="px-[12px] mt-[18px]">
                    {features.map(f => (
                        <li
                            key={f.name}
                            className="flex items-center gap-3 py-2 px-3 hover:bg-[#2e3350] rounded-lg cursor-pointer text-[26px] my-[10px]">
