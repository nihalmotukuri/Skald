...
const Sidebar = () => {
    ...
    return (
        <div
            className="bg-[#252a41] min-w-[260px] m-[24px] rounded-[24px] py-[28px] px-[12px] flex flex-col justify-between"
        >
            <div>
