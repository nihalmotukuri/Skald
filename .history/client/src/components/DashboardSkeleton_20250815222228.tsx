            ...
            <div className='col-span-2'>
                <div className='w-full h-[340px] grid grid-cols-[repeat(2,1fr)] gap-5 mb-5'>
                    <div className='grid grid-cols-[repeat(2,1fr)] grid-rows-[repeat(9,1fr)] gap-3'>
                        <Skeleton className='col-1 row-span-5 bg-white/2 backdrop-blur-md rounded-xl p-[18px] flex flex-col justify-end'>
                ...
                >
                    {/* <h1 className='font-bold text-[20px] text-center'>Most Recent Note</h1> */}
