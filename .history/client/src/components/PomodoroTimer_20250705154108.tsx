...
const PomodoroTimer = ({ duration = 2 * 60 }) => {
  ...
  return (
    <motion.div>
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg w-full py-0">
        <CardContent className="flex flex-col items-center justify-center h-full gap- p-6">
