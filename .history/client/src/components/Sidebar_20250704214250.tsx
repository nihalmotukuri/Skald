...
const Sidebar = () => {
    ...
    return (
        <div
            className="bg-[#252a41] min-w-[280px] m-[24px] rounded-[18px] p-[8px] flex flex-col justify-between"
        >
            <div>
                <div className="w-[240px] flex justify-center items-center mt-[10px]">
                    <img
                        src="/images/logo.png"
                ...
                <ul className="px-[12px] mt-[18px]">
                    {features.map(f => (
                        <li
                            key={f.name}
                            className="flex items-center gap-3 py-2 px-3 hover:bg-[#2e3350] rounded-lg cursor-pointer text-[18px] my-[10px]">
            ...
            <div className="flex items-center hover:bg-[#2e3350] p-[8px] rounded-[12px] cursor-pointer">
                <img 
