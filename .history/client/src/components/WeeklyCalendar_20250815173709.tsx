        ...
        <div className="grid grid-cols-7 text-center">
          ...
          {weekDays.map((day, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center h-10 w-10 rounded-lg text-md font-semibold !text-red-900 transition-colors
                    ${isSelected ? (isDark ? "bg-[#5a69ff]" : "bg-[#602bf8]") : (isDark ? "bg-black/10 " : "bg-white")} shadow-xs`}
                >
                  {day.getDate()}
                </div>
              </div>
