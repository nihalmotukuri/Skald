    ...
    return (
        <>
            <div className='col-span-2'>
                ...
                <Skeleton
                    className={`relative ${isDark ? "bg-white/2" : "bg-[#f5f5f5]"} p-[20px] mb-5 cursor-pointer hover:bg-white/4`}
                >
                    <Skeleton className={`w-[260px] h-[24px] rounded-xl mb-2 ${isDark ? "bg-white/10" : "bg-"}`} />
