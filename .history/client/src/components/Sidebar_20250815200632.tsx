...
const Sidebar = ({ user }: {user: User}) => {
  ...
  const closeSidebar = () => (
    ...
    >
      ...
      <div className="flex justify-center hover:bg-[#0f111a5f] p-[6px] m-[6px] rounded-[12px] cursor-pointer relative">
        <img
        ...
        <div className={`absolute ${isDark ? "bg-black" : "bg-white/60 border border-black/40 backdrop-blur"} top-0 left-0 h-full w-full rounded-[10px] flex justify-center items-center text-2xl`}>
          <IoIosLogOut />
        </div>
      </div>
    </motion.div>
