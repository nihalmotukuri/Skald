...
const Heatmap = () => {
  ...
  const darkPalette = [
    "#ffffff08", // level 0 - barely visible
    "#a3b4ff26", // level 1 - very subtle blue tint
    "#8799ff59", // level 2 - light blue
    "#5a69ff99", // level 3 - medium blue
    "#5a69ff"    // level 4 - vivid blue
  ];
  ...
  return (
    <motion.div>
      <Card className={`${isDark ? "text-slate-400 border-white/10 bg-white/2" : "text-[#2d3748] bg-white"} backdrop-blur-md border rounded-2xl shadow-xl p-6 w-full shadow-xl`}>
        <div className="px-6 pt-2">
          <p className="text-xs text-black/40 tracking-widest uppercase font-medium text-center">
            Weekly Activity
          </p>
          <p className="text-sm text-[#2d3748] text-center">Last 6 months of productivity</p>
        </div>
