...
const AddTaskDialog = ({ setDisplayAddTask }: AddTaskDialogProps) => {
    ...
    return (
        <section className={`fixed top-0 left-0 z-999 ${isDark ? "bg-black/40" : "!border-black/10 shadow-md hover:bg-neutral-200 text-gray-600"}  h-full w-full flex justify-center items-center`}>
            <form
                onSubmit={onAddTask}
