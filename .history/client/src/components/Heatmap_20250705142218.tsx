...
import "@/styles/heatmap-skald.css"; // <- custom color classes
...
export default function Heatmap() {
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg w-full max-w-[720px] m-auto">
