...
const Sidebar = ({ user }: {user: User}) => {
  ...
  const closeSidebar = () => (
    <motion.div
      className={`flex flex-col justify-between backdrop-blur-md border rounded-xl shadow-lg ${isDark ? "bg-white/5 border-white/10" : "bg-[#602bf8] text-[#2d3748] border-black/30"}`}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
    >
