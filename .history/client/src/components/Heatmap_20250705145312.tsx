...
const Heatmap = () => {
  ...
  const startDate = new Date(twMonthsAgo);
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg p-6 text-slate-400">
        <CardContent className="p-0">
          <ActivityCalendar
            ...
            renderBlock={(block, activity) => (
              <g className="text-slate-400">{block}
                <title>
                  {activity.count > 0
