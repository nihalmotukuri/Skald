            ...
            <div className='col-span-2'>
                <div className='w-full h-[340px] grid grid-cols-[repeat(2,1fr)] gap-5 mb-5'>
                    <div className='grid grid-cols-[repeat(2,1fr)] grid-rows-[repeat(9,1fr)] gap-3'>
                        ...
                        <Skeleton className='col-2 row-start-1 row-end-5 bg-white/2 backdrop-blur-md rounded-xl p-[18px] flex flex-col justify-end'>
                            <div>
                        ...
                        <${isDark ? "bg-white/2" : "bg-[#f5f5f5]"} backdrop-blur-md rounded-xl p-[18px] flex flex-col justify-end`}>
                            <div>
                                <Skeleton className={`h-[20px] w-[100px] ${isDark ? "bg-white/10" : "bg-black/10"} rounded-xl`} />
                                <Skeleton className={`h-[16px] w-[60px] ${isDark ? "bg-white/6" : "bg-black/6"} rounded-xl mt-2`} />
                            </div>
                        </Skeleton> className='col-2 row-start-5 row-end-10 bg-white/2 backdrop-blur-md rounded-xl p-[18px] flex flex-col justify-end'>
                            <div>
                                <Skeleton className='h-[20px] w-[100px] bg-white/10 rounded-xl' />
                                <Skeleton className='h-[16px] w-[60px] bg-white/6 rounded-xl mt-2' />
                            </div>
