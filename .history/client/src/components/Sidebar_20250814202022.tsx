...
const Sidebar = ({ user }: {user: User}) => {
  ...
  const closeSidebar = () => (
    <motion.div
      className={`rounded-[12px] flex flex-col justify-between backdrop-blur-md border border-white/10 rounded-2xl shadow-lg ${isDark ? "bg-white/5" : "bg-neutral-300 text-[#2d3748]"}`}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
    >
