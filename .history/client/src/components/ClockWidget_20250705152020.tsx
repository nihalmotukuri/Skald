...
const ClockWidget = () => {
  ...
  return (
    <motion.div>
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg w-full flex flex-col items-center justify-center p-6 ">
