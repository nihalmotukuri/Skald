            ...
            <div className="w-full flex items-center gap-4">
                ...
                <div className="w-full grid grid-cols-[1fr_160px_140px_30px] items-center">
                    <p className={`text-[16px] ${isDark ? "text-white font-medium" : "font-semibold"}`}>
                        ...
                        {task.taskList && (
                            <span className={`ml-[12px] text-[12px] py-[1px] px-[8px] rounded-xl ${isDark ? "text-gray-400 border-white/20" : "text-white bg-[#602bf8] border-transparent shadow-lg"} border`}>
                                {task.taskList}
                            </span>
                        )}
                    </p>
