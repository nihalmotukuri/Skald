        ...
        <ul className="px-[12px] mt-[18px]">
          {features.map((f) => (
            <li
              ...
              className={`flex items-center gap-3 py-2 px-3 rounded-lg cursor-pointer text-[18px] my-[8px] ${isActive(f.path) && isDark ? "bg-[#0f111a80]" : ""} ${isActive(f.path) && !isDark ? "bg-neutral-300" : ""}`}
            >
               ${isDark ? "hover:bg-[#0f111a5f" ? "bg-neutral-300" }
