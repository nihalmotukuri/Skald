...
const Sidebar = ({ user }: { user: User }) => {
  ...
  const openSidebar = () => (
    ...
    >
      ...
      <div
        className="flex items-center hover:bg-[#0f111a5f] p-[8px] rounded-[12px] cursor-pointer relative"
      ...
      >
        ...
        {showLogout
          ? (
            <div className={`absolute ${isDark ? "bg-white/20 backdrop-blur border border-white/60" : "bg-white/20 border border-black/40 backdrop-blur"} top-0 left-0 h-full w-full rounded-[10px] flex justify-center items-center text-2xl`}>
              <IoIosLogOut />
            </div>
          ) : null
        }
