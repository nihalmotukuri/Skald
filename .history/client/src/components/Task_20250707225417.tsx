...
const Task = ({ task, toggleTask }: TaskProps) => {
    ...
    return (
        <li className={`${openTask ? "auto" : "h-[64px]"} flex flex-col items-start justify-between bg-white/2 backdrop-blur-md border border-white/6 rounded-md shadow-lg p-4 overflow-hidden`}>
