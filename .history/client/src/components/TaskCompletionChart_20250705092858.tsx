...
const COLORS = ["#5a69ff", "#64748a3b4ffb"]; // green (completed), slate (remaining)
...
const TaskCompletionChart = ({ completed = 7, total = 10 }) => {
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg">
        <CardHeader>
