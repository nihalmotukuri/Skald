        ...
        <>
            ...
            <div className='col-span-1'>
                ...
                <Skeleton className={`mt-5 ${isDark ? "bg-white/2" : "bg-[#f5f5f5]"} rounded-2xl py-[20px] px-[26px]`}>
                    <Skeleton className={`mb-[16px] h-[24px] w-[150px] rounded-xl ${isDark ? "bg-white/10" : "bg-black/10"}`} />
                    ...
                    <ul className='flex flex-col gap-2'>
                        <Skeleton className={`h-[78px] w-full rounded-lg ${isDark ? "bg-white/2" : "bg-black/4"} p-3 py-4`}>
                            ...
                            <div className='flex justify-between'>
                                <Skeleton className={`h-[12px] w-[60px] ${isDark ? "bg-white/6" : "bg-black/6"}`} />
                                <Skeleton className={`h-[12px] w-[80px] ${isDark ? "bg-white/6" : "bg-black/6"}`} />
                            </div>
                        </Skeleton>
