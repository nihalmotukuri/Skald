...
const initialTasks: Task[] = [
  ...
  },
  {
    ...
    due: new Date("2025-07-07T09:00:00"),
    completed: false,
  },
  {
    id: 4,
...
const OnboardingTasks = () => {
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg text-slate-400 h-full w-full gap-4 overflow-x-scroll">
