        ...
        <section className={`fixed top-0 left-0 z-999 ${isDark ? "bg-black/40" : "bg-gray-300/30" } h-full w-full flex justify-center items-center`}>
            ...
            >
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <input
                        className={`${isDark ? "bg-white/5" : "bg-neutral-100/10 !border-black/20"} backdrop-blur-md border border-white/10 rounded-md text-[14px] px-[12px] py-[6px]`}
                        type="text"
                        name="title"
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <textarea
                        name="description"
                        className='bg-white/5 backdrop-blur-md border border-white/10 rounded-md text-[14px] px-[12px] py-[6px] resize-none'
                        rows={5}
