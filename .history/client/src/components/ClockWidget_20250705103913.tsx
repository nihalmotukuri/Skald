...
const ClockWidget = () => {
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg w-f h-[320px] flex items-center justify-center relative">
