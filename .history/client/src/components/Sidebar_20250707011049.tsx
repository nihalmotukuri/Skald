...
const Sidebar = () => {
  ...
  const openSidebar = () => (
    <motion.div
      className="bg-[#1b1d26] min-w-[280px] rounded-[18px] p-[8px] flex flex-col justify-between max-h-full bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
