...
const TaskCompletionChart = ({ total, completed }: TaskCompletionChartProps) => {
  ...
  return (
    <motion.div className="h-full w-full">
      <Card className={`${ isDark ? "bg-white/2 border-white/10" : "bg-gradient-to-br from-[#F7F8FA] to-white !text-[#2d3748] border-black/30" } backdrop-blur-md border text-white rounded-2xl shadow-lg h-full w-full`}>
