...
const WeeklyCalendar: React.FC = () => {
  ...
  return (
    <div className={`${isDark ? "text-gray-300 border-white/20 bg-white/2" : "text-black/60 border-black/20 bg-neutral-400/50"} backdrop-blur-md border rounded-2xl h-[210px] shadow-lg w-full p-[24px]`}>
