  ...
  const renderCenterLabel = () => {
    return (
      <foreignObject x="30" y="65" width="120" height="60">
        <div className="flex flex-col items-center justify-center w-full h-full text-white font-mono ml-[12px]">
          <span className="text-[12px] tracking-wide text-slate-400 w-full">TASKS COMPLETED</span>
