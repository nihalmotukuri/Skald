...
const Sidebar = () => {
    ...
    return (
        <div
            className="bg-[#252a41] w-[260px] m-[24px] rounded-[24px] py-[28px] px-[12px]"
        >
            ...
            <ul className="p-[12px]">
                {features.map(f => (
                    <li 
                        key={f.name} 
                        className="flex items-center gap-4 py-2 px-3 hover:bg-[#2e3350] rounded-lg cursor-pointer text-[18px] my-[18px]">
