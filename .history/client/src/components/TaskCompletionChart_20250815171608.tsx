...
const TaskCompletionChart = ({ total, completed }: TaskCompletionChartProps) => {
  ...
  return (
    <motion.div className="h-full w-full">
      <Card className={`${ isDark ? "bg-white/2 border-white/10" : "bg-white !text-[#2d3748]" } backdrop-blur-md text-white rounded-2xl shadow-xl h-full w-full`}>
        <CardContent className="flex items-center justify-center flex-col gap-3 pt-[36px] relative">
          ...
          <PieChart width={220} height={220}>
            ...
            >
              <Cell fill={isDark ? "#0f111a" : "#eae5f7"} />
            </Pie>
            ...
            {percentage > 0 && (
              ...
              >
                <Cell fill={isDark ? "#5a69ff" : "#a384fa"} />
              </Pie>
            )}
          </PieChart>
        </CardContent>
