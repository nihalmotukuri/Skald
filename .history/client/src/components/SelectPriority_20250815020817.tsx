...
const SelectPriority = ({ selectPriority, currentPriority }: Props) => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className={`${isDark ? "bg-white/5 border-white/10 text-white" : "bg-neutral-100/10 !border-black/20 text-gray-600"} backdrop-blur-[8px] border border-white/20 absolute z-00 right-[-66px]`}
       align="center">
        <DropdownMenuGroup>
          <DropdownMenuItem
