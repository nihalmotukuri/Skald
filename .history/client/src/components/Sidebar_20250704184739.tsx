...
const Sidebar = () => {
    ...
    return (
        <div
            className="bg-[#252a41] w-[240px] m-[24px] rounded-[24px] py-[28px] px-[12px] flex flex-col justify-between"
        >
            <div>
            ...
            <div className="h-[100px]">
                <img src="https://hds.hel.fi/images/foundation/visual-assets/placeholders/user-image-l@3x.png" alt="profile-pic" />
            </div>
        </div>
    )
}
