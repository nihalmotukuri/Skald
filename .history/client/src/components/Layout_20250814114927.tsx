...
const DashboardGrid = () => {
    ...
    return (
        <>
            <main className="bg-[#0f111a] flex p-[24px] gap-[24px] h-screen relative">
                {loading
                    ? (
                        <div className='bg-[##f4f5f7] backdrop-blur-sm absolute top-0 left-0 z-1 size-full flex justify-center items-center'>
                            <LineWobble
                                size="80"
                                stroke="5"
                                bgOpacity="0.1"
