  ...
  return (
    ...
    >
      <Card className={`bg-white/5 backdrop-blur-md border border-white/10 text-white rounded-2xl shadow-lg w-[320px] ${className}`}>
        ...
        <CardContent className="flex items-center justify-center pb-4" style={{fontFamily: '"DS-Digital", sans-serif'}}>
          <div className="text-5xl font-semibold tracking-widest font-mono">
            {formatTime(time)}
          </div>
        </CardContent>
      </Card>
