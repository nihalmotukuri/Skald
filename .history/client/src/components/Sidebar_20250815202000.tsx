  ...
  const openSidebar = () => (
    ...
    >
      ...
      >
        ...
        {showLogout
          ? (
            <div className={`absolute ${isDark ? "bg-white/2 backdrop-blur border border-white/620" : "bg-white/20 border border-black/40 backdrop-blur"} top-0 left-0 h-full w-full rounded-[10px] flex justify-center items-center text-2xl`}>
