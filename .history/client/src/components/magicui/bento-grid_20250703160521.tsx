...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // light styles
      "bg-background [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] bg-gray-500 hover:bg-gray-600",
      // dark styles
  ...
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300">
        <Icon className="h-12 w-12 origin-left transform-gpu text-white-700 transition-all duration-300 ease-in-out" />
