...
const Heatmap = () => {
  ...
  return (
    ...
    >
      <Card className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg p-6 text-slate-400 h-full w-full">
        <div className="mb-4">
        ...
        <CardContent className="p-0 overflow-x-auto max-w-full my-auto">
          <ActivityCalendar
            data={mergedData}
            hideTotalCount
            blockSize={18}
